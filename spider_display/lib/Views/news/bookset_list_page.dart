...
typedef LoadMoreCallback = void Function(LoadMoreState2);
typedef LoadMoreUpdateCallback = void Function(LoadMoreState2, double);
      ...
      onNotification: (notication) {
        ...
        if (!isLoading) {
          ...
          if (widget.loadMoreCallback != null) {
            setState(() {
              widget.loadMoreCallback(LoadMoreState2.Normal);
            });
          }
...
//              print("滑动到底部！");
              ...
              setState(() {
                if (widget.loadMoreCallback != null) {
                  widget.loadMoreCallback(LoadMoreState2.Start);
                }
                loadText = "加载中...";
                isLoading = true;
              });
...
//          print("结束滑动！");
          ...
          if (curMaxHeight > normalMaxHeight) {
            if (pixels > normalMaxHeight && pixels < curMaxHeight - 20.0) {
              ...
              if (widget.loadMoreCallback != null) {
                setState(() {
                  widget.loadMoreCallback(LoadMoreState2.Loading);
                });
                widget.loadMore().then((T) {
                  print("success: ${DateTime.now()}");
                  setState(() {
                    widget.loadMoreCallback(LoadMoreState2.Success);
                  ...
                  setState(() {
                    widget.loadMoreCallback(LoadMoreState2.Error);
                  });
                });
              }
            }
              ...
              setState(() {
                ...
                if (widget.loadMoreUpdateCallback != null) {
                  widget.loadMoreUpdateCallback(
                      LoadMoreState2.Update, dragPercent);
                }
//                print("dragPercent: ${dragPercent}");
              ...
              if (widget.loadMoreCallback != null) {
                setState(() {
                  widget.loadMoreCallback(LoadMoreState2.Ready);
                });
              }
            }
          }
